...
The plugin utilizes three action hooks:
...
= I'm using another plugin which alters excerpts in the      Admin area, and this plugin disables these features - can this be fixed? =
...
* Bumped "Tested up to" value to WordPress 4.0 and updated screenshot.
